...
SDE = S.DoubleWellPotential(sigma=1.2)
a = -0.5
b = 1.5
X0 = 0.25
...
for method, fun in methods_dict.items():
    ...
    results_dic = {'SDE':'DWPotential', 'Method':method, 'timesteps':timesteps,
...
'''
with open('./Results/DWPotential_EXPV.pickle', 'rb') as handle:
